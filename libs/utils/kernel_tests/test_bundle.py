...
from libs.utils.wlgen2.rta import RTA
...
class RTATestBundle(TestBundle):
    """
    "Abstract" class for :class:`libs.utils.wlgen2.rta.RTA`-powered TestBundles
    ...
    TASK_PERIOD_MS=16
    """
    A task period you can re-use for your :class:`libs.utils.wlgen2.rta.RTATask`
    definitions.
    """
